        ...
        return (
            <div align='center'>
                ...
                <InputGroup>
                    ...
                    <Input placeholder="Input 1st value here" className = 'm-2' onChange = {(e) => {this.setState( {storedValue: this.state.storedValue_1 = e.target.value} )}}></Input>                    
                </InputGroup>
                <InputGroup>
                    <Input placeholder="Input 2nd value here" className = 'm-2' onChange = {(e) => {this.setState( {storedValue: this.state.storedValue_2 = e.target.value} )}}></Input>
                </InputGroup>
                <br></br>
                <div>
                    {this.state.storedValue_1} {this.state.currentState} {this.state.storedValue_2} = {this.chooseOperator()}
                </div>
                <br></br>
